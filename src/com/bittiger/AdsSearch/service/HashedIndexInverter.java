...
/**
 * This class is deprecated, we use HashMap in Java to cache token->ads relationship.
 * This class is kept for future comparison between Java cache and Redis cache.
 * @author liushiyao
 *
 */
@Service
@Deprecated
public class HashedIndexInverter {
